	...
	<body id="top">
		...
		<!-- Header -->
			<header id="header" class="skel-layers-fixed">
				<h1><a href="#">ADMIN HOME PAGE </a></h1>
				<nav id="nav">
					<ul>
						<li><a href="adminview_user.php">USER</a></li>
						<li><a href="adminview_feedback.php">FEEDBACK</a></li>
						<li><a href="adminview_product.php">PRODUCT</a></li>
                        <li><a href="adminlogout.php" class="button special"> LOGOUT </a></li>
